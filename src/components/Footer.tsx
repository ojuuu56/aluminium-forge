...
const Footer = () => {
  ...
  }} className="relative py-16 overflow-hidden text-primary">
      {/* Top line */}
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Home", "Services", "Gallery", "About", "Contact"].map(link => <li key={link}>
                  <a href={`#${link.toLowerCase()}`} className="font-body text-muted-foreground hover:text-glass transition-colors">
                    {link}
                  </a>
                </li>)}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://wa.me/9779862198360" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
